  ...
  return (
    ...
    >
      ...
      <div className="flex-1 max-w-xs ml-4">
        <div
          className="rounded-md px-2.5 py-1 text-xs flex items-center justify-between"
          style={{
      ...
      <nav className="flex gap-5 ml-auto text-[13px]">
        <Link href="/" className="hover:opacity-80 transition-opacity" style={{ color: "var(--fg-default)" }}>
          Projects
        </Link>
        <Link href="/about" className="hover:opacity-80 transition-opacity" style={{ color: "var(--fg-default)" }}>
          About
        </Link>
